const I18N = {
  pt: {
    ...
    selectRect: "Seleção □", selectLasso: "Laço",
    zoom: "Zoom", clear: "Limpar", showNumbers: "Mostrar números",
    brushSize: "Tamanho do pincel", symmetry: "Simetria",
    reference: "Imagem de referência", opacity: "Opacidade",
    applyCrop: "Aplicar", cropResizeTitle: "Adaptar grid à imagem cortada",
    textTool: "T Texto", addText: "Adicionar texto", textContent: "Texto:",
    textFont: "Fonte:", textHeight: "Altura", textBackground: "Pintar fundo retangular",
    clickToPlace: "Aplicar (clique pra posicionar)",
    ...
    updateExisting: "Atualizar", saveAsNew: "Salvar como novo",
  ...
  en: {
    ...
    selectRect: "Selection □", selectLasso: "Lasso",
    zoom: "Zoom", clear: "Clear", showNumbers: "Show numbers",
    brushSize: "Brush size", symmetry: "Symmetry",
    reference: "Reference image", opacity: "Opacity",
    applyCrop: "Apply", cropResizeTitle: "Adapt grid to cropped image",
    textTool: "T Text", addText: "Add text", textContent: "Text:",
    textFont: "Font:", textHeight: "Height", textBackground: "Paint rectangular background",
    clickToPlace: "Apply (click to place)",
    ...
    updateExisting: "Update", saveAsNew: "Save as new",
